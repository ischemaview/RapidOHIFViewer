    ...
    retrieve: {
      ...
      directURL: params => {
        ...
        if (BulkDataURI.indexOf('/') === 0) {
          return _dicomWebConfig.wadoRoot + acceptUri;
        }
        if (BulkDataURI.indexOf('series/') == 0) {
          return `${_dicomWebConfig.wadoRoot}/studies/${StudyInstanceUID}/${acceptUri}`;
        }
        if (BulkDataURI.indexOf('instances/') === 0) {
          return `${_dicomWebConfig.wadoRoot}/studies/${StudyInstanceUID}/series/${SeriesInstanceUID}/${acceptUri}`;
        }
